...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tinymce_tinymce_vue__ = __webpack_require__(37);



Object.defineProperty(__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype, '$http', { value: __WEBPACK_IMPORTED_MODULE_1_axios___default.a });


Object.defineProperty(__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype, '$lodash', { value: __WEBPACK_IMPORTED_MODULE_2_lodash___default.a });



//let tinymceApiKey = document.head.querySelector('meta[name="tinymce-api-key"]');

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('content-item', __webpack_require__(42));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('content-items', __webpack_require__(45));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('editor', __WEBPACK_IMPORTED_MODULE_3__tinymce_tinymce_vue__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Editor__ = __webpack_require__(38);
/**
 * Copyright (c) 2018-present, Ephox, Inc.
 *
 * This source code is licensed under the Apache 2 license found in the
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ScriptLoader__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TinyMCE__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utils__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EditorPropTypes__ = __webpack_require__(41);
/**
 * Copyright (c) 2018-present, Ephox, Inc.
 *
 * This source code is licensed under the Apache 2 license found in the
...
Component.options.__file = "resources/js/components/ContentItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d7e77de", Component.options)
  } else {
    hotAPI.reload("data-v-7d7e77de", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        publish: function publish() {
            ...
            this.$http.post('/content/publish', post_data).then(function (response) {
                _this.content.original_bodytext = _this.content.bodytext;
                _this.saved();
            }, function (error) {});
        },
        ...
        updateBodytext: _.debounce(function () {
            var _this3 = this;
            ...
            this.$http.post('/content/update', post_data).then(function (response) {
                _this3.saved();
            }, function (error) {});
        }, 1000)
...
var render = function() {
  ...
  return _c(
    ...
    [
          ...
          _c("div", { staticClass: "content-title" }, [
            _c(
              "div",
              {
                ...
                class: _vm.showText ? "expanded" : ""
              },
              [_c("i", { staticClass: "fas fa-angle-down" })]
            ),
            _vm._v(" "),
            _c("div", [_vm._v(_vm._s(_vm.content.header))])
          ]),
          _vm._v(" "),
          _c(
            "div",
            ...
            [
              _c("transition", { attrs: { name: "saving", mode: "in-out" } }, [
                _c(
                  "div",
                  {
                    directives: [
                    ...
                    staticClass: "content-status-icon saving-icon"
                  },
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.status == "published",
                      expression: "status == 'published'"
                    }
                  ],
                  staticClass: "content-status-icon published"
                },
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.status == "changed",
                      expression: "status == 'changed'"
                    }
                  ],
                  staticClass: "content-status-icon changed"
                },
                [
                  _vm.canPublish
                    ? _c(
      ...
      _vm._v(" "),
      _c("transition", { attrs: { name: "expander" } }, [
        _vm.showText
          ? _c(
              "div",
              { staticClass: "content-bodytext" },
              [
                _c("editor", {
                  attrs: {
                    "api-key":
                      "cnqsdiwqe98zykav18rvw2dqp0ykt34jhuvg268m11w0ax1c",
                    init: { height: 350 }
                  },
                  model: {
                    value: _vm.content.bodytext,
                    callback: function($$v) {
                      _vm.$set(_vm.content, "bodytext", $$v)
                    },
                    expression: "content.bodytext"
                  }
                })
              ],
              1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7d7e77de", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/ContentItems.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a835f32", Component.options)
  } else {
    hotAPI.reload("data-v-6a835f32", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        loadContent: function loadContent() {
            ...
            this.$http.post('/content/load').then(function (response) {
                _this.contentItems = response.data.contentItems;
            }, function (error) {
                console.log('there was an error');
            });
        },

        addContentById: function addContentById() {
            var _this2 = this;

            this.$http.post('/content/create', { 'id': this.addId }).then(function (response) {
                _this2.addId = '';
                _this2.loadContent();
            }, function (error) {
                console.log('there was an error');
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "content-items" }, [
    _vm.canAddCourses
      ? _c("div", { staticClass: "section" }, [
          _c("div", { staticClass: "input-block" }, [
            _c("div", { staticClass: "input-label" }, [
              _vm._v("Add Content By External ID")
            ]),
            _vm._v(" "),
              ...
              _c("input", {
                ...
                on: {
                  keyup: function($event) {
                    ...
                    $event.preventDefault()
                    $event.stopPropagation()
                    return _vm.addContentById($event)
                  },
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.addId = $event.target.value
                  }
                }
              })
            ])
    ...
    _c(
      "div",
      { staticClass: "section" },
      _vm._l(_vm.contentItems, function(content) {
        return _c("content-item", {
          key: content.id,
          attrs: { "can-publish": _vm.canPublish, content: content }
        })
      })
    )
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6a835f32", module.exports)
  }
}
